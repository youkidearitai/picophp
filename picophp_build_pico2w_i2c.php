 ...
 *   picophp_compile_pico2w_i2c.php
 *   picophp_vm_pico2w_i2c.c
 */
...
function main(array $argv): int {
    ...
    copy($vm, $outDir . DIRECTORY_SEPARATOR . 'picophp_vm_pico2w_i2c.c');
    ...
    run_cmd([
        ...
        '-I' . $outDir,
        $outDir . DIRECTORY_SEPARATOR . 'picophp_vm_pico2w_i2c.c',
        '-lm',
        '-o',
        $exe,
    ]);
